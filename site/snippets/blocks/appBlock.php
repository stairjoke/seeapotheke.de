<div class="appBlock">
	...
	<div class="links">
		<?php if($appStore = $block->appStore()): ?>
			<a href="<?= $appStore ?>"><img alt="Apple AppStore Ikone" src="/assets/img/Apple AppStore.svg" /></a>
		<?php endif; ?>
		<?php if($playStore = $block->playStore()): ?>
			<a href="<?= $playStore ?>"><img alt="Apple AppStore Ikone" src="/assets/img/Google SVG.svg" /></a>
		<?php endif; ?>
	</div>
	<?= $block->info()->kt() ?>
</div>